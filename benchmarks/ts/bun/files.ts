...
const performBenchmarkBun = async (numberOfFiles: number, numOfParagraphs: number, filePrefix = "lorem") => {
	const startTime = performance.now();
...
const performBenchmarkFs = (numberOfFiles: number, numOfParagraphs: number, filePrefix = "lorem") => {
	const startTime = performance.now();
