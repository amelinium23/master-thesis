...
\addcontentsline{toc}{subsection}{Wybrane narzędzi i algorytmy}
...
\addcontentsline{toc}{subsection}{Algorytmy sortowania}
...
\subsection*{Sortowanie bąbelkowe (\textit{ang. Bubble Sort})}
\addcontentsline{toc}{subsubsection}{Sortowanie bąbelkowe (\textit{ang. Bubble Sort})}
...
\subsection*{Sortowanie szybkie (\textit{ang. Quick Sort})}
\addcontentsline{toc}{subsubsection}{Sortowanie szybkie (\textit{ang. Quick Sort})}
...
\subsection*{Sortowanie pozycyjne (\textit{ang. Radix Sort})}
\addcontentsline{toc}{subsubsection}{Sortowanie pozycyjne (\textit{ang. Radix Sort})}
...
\addcontentsline{toc}{subsection}{Algorytmy Kodowania}
...
\section*{Bazy danych}
\addcontentsline{toc}{subsection}{Bazy danych}
